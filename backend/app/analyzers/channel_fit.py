...
class ChannelFitAnalyzer(BaseAnalyzer):
    ...
    async def analyze(self) -> AnalyzerResult:
        try:
            ...
            result_data = {
                ...
                "low_priority_channels": [c.channel for c in channel_scores if c.score <= 4],
    ...
    def _infer_product_type(self) -> str:
        ...
        b2b_keywords = ["enterprise", "business", "teams", "company", "api", "integration"]
    ...
    def _score_channels(self) -> List[ChannelScore]:
        ...
        scores.append(ChannelScore(
            ...
            rationale="Essential for real-time engagement and industry conversations." if is_crypto else "Good for thought leadership and announcements.",
        ...
        scores.append(ChannelScore(
            ...
            rationale="Best for visual, consumer-focused content." if tiktok_score > 4 else "Low priority for B2B/technical products.",
        ...
        scores.append(ChannelScore(
            ...
            rationale="Essential for community building in crypto/gaming." if is_crypto else "Good for engaged user communities.",
    ...
    def _get_underutilized(self) -> List[str]:
        ...
        return [
            ...
            if c.score >= 7 and not c.current_presence
        ]
    ...
    def _generate_findings(self) -> List[Finding]:
        ...
        if underutilized:
            findings.append(Finding(
                title=f"Underutilized High-Potential Channels",
