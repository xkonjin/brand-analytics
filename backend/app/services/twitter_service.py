...
class TwitterAnalysis:
    ...
    # Content analysis
    tweet_types: Dict[str, int] = field(default_factory=dict)  # original, retweet, reply
...
class TwitterService:
    ...
    def _calculate_metrics(
        ...
        now = datetime.now(tweets[0].created_at.tzinfo if tweets and tweets[0].created_at.tzinfo else None)
        ...
        if tweets:
            ...
            days_since_last_post = (now.replace(tzinfo=None) - newest.replace(tzinfo=None)).days if newest else 0
