...
class ApifyService:
    ...
    def _parse_instagram_results(
        ...
        engagement_rate = ((avg_likes + avg_comments) / max(followers, 1)) * 100 if followers else 0
        ...
        return InstagramProfile(
            ...
            followers_count=profile_data.get("followersCount", profile_data.get("follower_count", 0)),
            following_count=profile_data.get("followingCount", profile_data.get("following_count", 0)),
            posts_count=profile_data.get("postsCount", profile_data.get("media_count", len(posts))),
            is_verified=profile_data.get("verified", profile_data.get("is_verified", False)),
            is_business=profile_data.get("isBusinessAccount", profile_data.get("is_business", False)),
            profile_pic_url=profile_data.get("profilePicUrl", profile_data.get("profile_pic_url")),
            external_url=profile_data.get("externalUrl", profile_data.get("external_url")),
    ...
    def _get_mock_instagram(self, username: str) -> InstagramProfile:
        ...
        return InstagramProfile(
            ...
            is_business=True,
            recent_posts=[
                {"id": "1", "likes": 500, "comments": 25, "caption": "New product launch!"},
                {"id": "2", "likes": 350, "comments": 18, "caption": "Behind the scenes"},
            ],
            avg_likes=425,
            avg_comments=21.5,
    ...
    def _parse_youtube_results(
        ...
        return YouTubeChannel(
            ...
            description=channel_data.get("description", "")[:500] if channel_data.get("description") else None,
            subscribers_count=channel_data.get("subscriberCount", channel_data.get("subscribers", 0)),
    ...
    def _get_mock_youtube(self, channel_id: str) -> YouTubeChannel:
        ...
        return YouTubeChannel(
            ...
            total_views=5000000,
            recent_videos=[
                {"id": "1", "title": "Latest Update", "views": 25000, "likes": 1500, "comments": 200},
                {"id": "2", "title": "Product Review", "views": 18000, "likes": 1200, "comments": 150},
            ],
            avg_views=21500,
            avg_likes=1350,
            avg_comments=175,
    ...
    async def scrape_reddit_mentions(
        ...
        try:
            run_input = {
                ...
                "maxPostCount": min(max_results, self.DEFAULT_LIMITS["reddit_mentions"]),
    ...
    def _parse_reddit_results(
        ...
        for item in items:
            ...
            mentions.append(RedditMention(
                ...
                body=item.get("body", item.get("text", ""))[:500] if item.get("body") or item.get("text") else None,
