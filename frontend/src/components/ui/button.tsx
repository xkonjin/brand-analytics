...
const buttonVariants = cva(
  [
    ...
    "rounded-xl font-medium transition-all duration-150 ease-out",
    ...
    variants: {
      variant: {
        ...
        default: [
          ...
          "hover:shadow-[0_8px_25px_rgba(59,130,246,0.3)]",
          "hover:scale-[1.01] hover:brightness-110",
          "active:scale-[0.98]",
        ],
        // Secondary - Glass aesthetic (formerly glass)
        secondary: [
        ...
        destructive: [
          ...
          "shadow-[0_4px_20px_rgba(239,68,68,0.2)]",
