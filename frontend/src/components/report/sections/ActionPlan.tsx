      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/60 max-w-2xl">
            Prioritized recommendations based on impact and effort. Start with
            Quick Wins for immediate improvements with minimal effort.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-emerald-500/10 backdrop-blur-xl rounded-xl border border-emerald-500/20 p-3 text-center">
          ...
          <div className="bg-red-500/10 backdrop-blur-xl rounded-xl border border-red-500/20 p-3 text-center">
            <div className="text-2xl font-bold text-red-400 mb-1">
              {criticalRecs.length}
            </div>
            <span className="text-sm text-red-300/70">Critical</span>
          </div>
          <div className="bg-orange-500/10 backdrop-blur-xl rounded-xl border border-orange-500/20 p-3 text-center">
            <div className="text-2xl font-bold text-orange-400 mb-1">
              {highRecs.length}
            </div>
            <span className="text-sm text-orange-300/70">High Priority</span>
          </div>
          <div className="bg-white/[0.05] backdrop-blur-xl rounded-xl border border-white/[0.1] p-3 text-center">
            <div className="text-2xl font-bold text-white/80 mb-1">
              {mediumRecs.length + lowRecs.length}
            </div>
        ...
        {recommendations.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-white/60 max-w-md mx-auto">
              No major recommendations at this time. Your brand is performing
              well across all analyzed dimensions.
            </p>
          </div>
        )}
      </div>
