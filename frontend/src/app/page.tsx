    ...
    <main className="min-h-screen">
      ...
      <section className="relative pt-8 pb-16 md:pt-20 md:pb-32 overflow-hidden">
        <div className="container-glass relative z-10">
          ...
          >
            Analyze your SEO, social media, brand messaging, and more in
            minutes. Get actionable insights to grow your brand.
          </motion.p>
        ...
        <div className="container-glass">
          ...
          >
            ...
            <p className="text-white/60 max-w-2xl mx-auto">
              Get a complete audit covering every aspect of your brand&apos;s
              online presence
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-white/70 mb-8 max-w-xl mx-auto">
                Get a comprehensive analysis of your brand&apos;s digital
                presence in minutes. Just $0.10 per analysis, no signup
                required.
              </p>
              <Button
                variant="default"
...
const features: FeatureCardProps[] = [
  {
    ...
    description:
      "Page speed, meta tags, indexing status, and technical SEO health analysis",
  ...
  },
  {
    ...
    title: "Social Media",
    description:
      "Follower counts, engagement rates, and content strategy insights",
  ...
  },
  {
    ...
    description:
      "Brand archetype analysis, voice consistency, and value proposition clarity",
  ...
  },
  {
    ...
    description:
      "How well AI assistants and search engines understand your brand",
  ...
  },
  {
    ...
    description:
      "Content mix, sentiment analysis, and topic coverage evaluation",
